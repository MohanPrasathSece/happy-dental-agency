        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              <a
                href="https://www.facebook.com/profile.php?id=61587083437951"
                target="_blank"
              ...
              <a
                href="https://instagram.com/happydentalagencyuk"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-champagne hover:text-navy transition-all"
              ...
              <a
                href="https://x.com/happydentalAG"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-champagne hover:text-navy transition-all"
                aria-label="Twitter"
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-3 text-sm text-white/80">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <span>Sat - Sun: 7:00 AM - 10:00 AM</span>
                </div>
              </li>
            </ul>
          </div>
