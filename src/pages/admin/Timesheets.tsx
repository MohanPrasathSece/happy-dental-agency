...
const AdminTimesheets = () => {
    ...
    const [invoiceData, setInvoiceData] = useState({
        ...
        agencyName: "Happy Dental Agency Ltd",
        agencyAddressLine1: "Capital Office, 124 City Road",
        agencyAddressLine2: "London, EC1V 2NX",
        agencyEmail: "info@happydentalagency.co.uk",
        agencyWebsite: "www.happydentalagency.co.uk",
        agencyPhone: "+44 7944 624039",
        ...
        practiceName: "",
        practiceEmail: "",
        billToSubtitle: "Professional Nursing Services",
        shiftDate: "",
        totalHours: 0,
        hourlyRate: 20,
        verifierName: "",
    ...
    const openInvoiceDialog = (ts: Timesheet) => {
        ...
        setInvoiceData({
            ...
            nursePhone: "", // Admin can fill/edit this for the invoice
            nurseAddress: "", // Admin can fill/edit this for the invoice
                ...
                <DialogContent className="max-w-[1000px] w-[95vw] max-h-[90vh] flex flex-col p-0 overflow-hidden bg-white rounded-2xl">
                    ...
                    <div className="flex-1 overflow-y-auto p-4 md:p-8 space-y-8 bg-gray-50/50">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                            ...
                            <div className="space-y-2">
                                <Label className="text-[10px] font-bold uppercase tracking-widest text-gray-400">Invoice Title</Label>
                                <Input value={invoiceData.invoiceTitle} onChange={e => setInvoiceData({ ...invoiceData, invoiceTitle: e.target.value })} className="h-9" />
                            </div>
                            <div className="space-y-2">
                            ...
                            <div className="space-y-2">
                                <Label className="text-[10px] font-bold uppercase tracking-widest text-gray-400">Agency Name</Label>
                                <Input value={invoiceData.agencyName} onChange={e => setInvoiceData({ ...invoiceData, agencyName: e.target.value })} className="h-9" />
                            </div>
                            <div className="space-y-2">
                                <Label className="text-[10px] font-bold uppercase tracking-widest text-gray-400">Agency Address Line 1</Label>
                                <Input value={invoiceData.agencyAddressLine1} onChange={e => setInvoiceData({ ...invoiceData, agencyAddressLine1: e.target.value })} className="h-9" />
                            </div>
                            <div className="space-y-2">
                                <Label className="text-[10px] font-bold uppercase tracking-widest text-gray-400">Agency Address Line 2</Label>
                                <Input value={invoiceData.agencyAddressLine2} onChange={e => setInvoiceData({ ...invoiceData, agencyAddressLine2: e.target.value })} className="h-9" />
                            </div>
                            <div className="space-y-2">
                                <Label className="text-[10px] font-bold uppercase tracking-widest text-gray-400">Agency Email</Label>
                                <Input value={invoiceData.agencyEmail} onChange={e => setInvoiceData({ ...invoiceData, agencyEmail: e.target.value })} className="h-9" />
                            </div>
                            <div className="space-y-2">
                                <Label className="text-[10px] font-bold uppercase tracking-widest text-gray-400">Agency Website</Label>
                                <Input value={invoiceData.agencyWebsite} onChange={e => setInvoiceData({ ...invoiceData, agencyWebsite: e.target.value })} className="h-9" />
                            </div>
                            <div className="space-y-2">
                                <Label className="text-[10px] font-bold uppercase tracking-widest text-gray-400">Agency Phone</Label>
                                <Input value={invoiceData.agencyPhone} onChange={e => setInvoiceData({ ...invoiceData, agencyPhone: e.target.value })} className="h-9" />
                            </div>
                            <div className="space-y-2">
                            ...
                            <div className="space-y-2">
                                <Label className="text-[10px] font-bold uppercase tracking-widest text-gray-400">Bill To Subtitle</Label>
                                <Input value={invoiceData.billToSubtitle} onChange={e => setInvoiceData({ ...invoiceData, billToSubtitle: e.target.value })} className="h-9" />
                            </div>
                            <div className="space-y-2">
                                <Label className="text-[10px] font-bold uppercase tracking-widest text-gray-400">Provider Name</Label>
                                <Input value={invoiceData.nurseName} onChange={e => setInvoiceData({ ...invoiceData, nurseName: e.target.value })} className="h-9" />
                            </div>
                            <div className="space-y-2">
                                <Label className="text-[10px] font-bold uppercase tracking-widest text-gray-400">Provider Email</Label>
                                <Input value={invoiceData.nurseEmail} onChange={e => setInvoiceData({ ...invoiceData, nurseEmail: e.target.value })} className="h-9" />
                            </div>
                            <div className="space-y-2">
                                <Label className="text-[10px] font-bold uppercase tracking-widest text-gray-400">Provider Phone</Label>
                                <Input value={invoiceData.nursePhone} onChange={e => setInvoiceData({ ...invoiceData, nursePhone: e.target.value })} className="h-9" />
                            </div>
                            <div className="space-y-2">
                                <Label className="text-[10px] font-bold uppercase tracking-widest text-gray-400">Shift Date</Label>
                                <Input type="date" value={invoiceData.shiftDate} onChange={e => setInvoiceData({ ...invoiceData, shiftDate: e.target.value })} className="h-9" />
                            </div>
                            <div className="space-y-2">
                            ...
                            <div className="space-y-2 md:col-span-2">
                                <Label className="text-[10px] font-bold uppercase tracking-widest text-gray-400">Footer Text</Label>
                                <Input value={invoiceData.footerText} onChange={e => setInvoiceData({ ...invoiceData, footerText: e.target.value })} className="h-9" />
                            </div>
                        </div>
                                ...
                                <div className="header">
                                    <div className="header-left">
                                        ...
                                        <div className="agency-info">
                                            <p className="font-bold text-navy" style={{ fontSize: '13px' }}>{invoiceData.agencyName}</p>
                                            <p>{invoiceData.agencyAddressLine1}</p>
                                            <p>{invoiceData.agencyAddressLine2}</p>
                                            <p>{invoiceData.agencyEmail}</p>
                                            <p>{invoiceData.agencyWebsite}</p>
                                            <p>{invoiceData.agencyPhone}</p>
                                        </div>
                                    </div>
                                    <div className="header-right text-right">
                                        <h1 className="invoice-title">{invoiceData.invoiceTitle}</h1>
                                ...
                                <div className="billing-grid">
                                    <div className="bill-to-sect">
                                        ...
                                        <div className="bill-content">
                                            ...
                                            <p>{invoiceData.billToSubtitle}</p>
                                    ...
                                    <div className="bill-to-sect text-right">
                                        ...
                                        <div className="bill-content">
                                            ...
                                            {invoiceData.nursePhone ? <p className="font-medium">{invoiceData.nursePhone}</p> : null}
                                            {invoiceData.nurseAddress ? <p>{invoiceData.nurseAddress}</p> : null}
